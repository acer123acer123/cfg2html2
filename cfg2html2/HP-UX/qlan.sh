...
# @(#) $Id: qlan.sh,v 4.11 2008-11-13 19:53:44 ralproth Exp $
# http://hpindkb.cup.hp.com/FAST-ETHERNETS/home/products/qlan.fe
# hpux 11iv1: /usr/contrib/bin/perl
# hpux 11iv2: /opt/perl/bin/perl
...
#================================================
if ($args{"-h"} == 1) {
    print "qlan version 0.5p3 -- prototype lan tool\n";
